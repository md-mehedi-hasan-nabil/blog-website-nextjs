      ...
      <main className='container'>
          ...
          <div className='col-span-12 md:col-span-8'>
            ...
            <div>
              ...
              <div className='grid grid-cols-12 gap-4 md:gap-8 py-6'>
                {/* show two blog */}
                {
                  blogsData.slice(0, 2).map(blog => <Blog key={blog.id} blog={blog} className="col-span-12 md:col-span-6" />)
                }
                </div>
            </div>
          </div>
        ...
        <div>
          <div className='grid grid-cols-12 gap-6'>
            {
              blogsData.slice(2).map(blog => <Blog key={blog.id} blog={blog} className="col-span-12 md:col-span-4 my-2" />)
            }
          </div>
