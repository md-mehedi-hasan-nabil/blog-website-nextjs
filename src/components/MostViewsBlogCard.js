...
export default function MostViewsBlogCard() {
    return (
        <div className='py-3'>
            <Image width={305} height={240} className='w-full h-60 object-cover rounded-3xl shadow-lg' src="https://images.unsplash.com/photo-1439405326854-014607f694d7" alt="" />
