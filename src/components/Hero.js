        ...
        <>
            <div className='relative bg-white h-[80vh] flex justify-center items-center'>
                ...
                <div className='flex flex-col gap-8'>
                    <h1 className='tracking-wider text-4xl md:text-6xl text-center font-bold leading-[68px]'> Simple Wisdom for <br /> Complex Lives</h1>
                    <p className='text-center text-lg text-[#1F1F1F] md:leading-9'>A blog, short for weblog, is a frequently updated web page used for <br /> personal commentary or business content. Blogs are often <br /> interactive and include sections at the bottom.</p>
